            ...
            { !this.state.showSearch ? (
              <div>
                <section className="welcomeSection columns">
                  <h2 className="welcome">Explore the Learning Curve Library</h2>
                  <p>Lorem ipsum dolor sit amet, noam ne, at est persius maiorum volutpat. Et magna phaedrum cum, est ad luptatum facilisis, tamquam phaedrum cum, est ad luptatum facilisis, tamquam dissent.</p>
                </section>
